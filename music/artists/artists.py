...
def browse_artists_alphabetical_order():
    ...
    return render_template('artists/simple_artist.html', artists=artists_alphabet_dict, selected_tracks=utilities.get_top_tracks())
...
def display_artist_info(artist_id):
    ...
    return render_template('artists/artist_info.html', artist=chosen_artist, tracks=tracks_by_chosen_artist, selected_tracks=utilities.get_top_tracks())
